  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        progressRef.current = () => {
          setStepMsg(STEP_MSG_MAP[taskProps.stepId]);

          console.log(taskProps.stepId, STEP_MSG_MAP[taskProps.stepId]);

          setProgress(taskProps.stepId * progressInc);
        ...
        if (taskProps.stepId === STEP_ID.NINE) {
